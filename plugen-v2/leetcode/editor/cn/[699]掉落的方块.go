...
//
// 
// Related Topics 线段树 数组 有序集合 👍 93 👎 0
package main
...
func fallingSquares(positions [][]int) []int {
	tree := make([]int, len(positions) * 4)


}

func buildSegmentTree(nodes []int, treeIndex int, data [][]int, l, r int) (int, int) {

	if l == r {
		nodes[treeIndex] = data[l][1]
	}
...
func querySegmentTree(nodes []int, start, end int) int {

...
// 给定的树为二叉搜索树。 
// 
// Related Topics 树 深度优先搜索 二叉搜索树 二叉树 👍 669 👎 0
package main
...
func _convertBST(root *TreeNode) *TreeNode {
	if root == nil {
		return nil
	}
...
func gtl(root *TreeNode, al int) {
	if root == nil {
		return
	}
	fmt.Println(root.Val, al)
